...
- [ ] MQTT Server Conformance Clause
  - [ ] ! CONNECT Actions
    ...
    - [ ] MQTT 3.1.4.4: The Server MUST perform the processing of Clean Start.
      - [ ] MQTT-3.1.2-4: If a CONNECT packet is received with Clean Start is set to 0, the Client and Server MUST discard any existing Session and start a new Session.
